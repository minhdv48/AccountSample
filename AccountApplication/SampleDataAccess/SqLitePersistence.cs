...
namespace SampleDataAccess
{
    ...
    {
        public void AddClient(IClient c) { AddElement((SampleDataModel.AccChart)c); }
        public void UpdateClient(IClient c) { UpdateElement((SampleDataModel.AccChart)c); }
        public void RemoveClient(int id) { RemoveElement<SampleDataModel.AccChart>(id); }
        public Task<List<IClient>> GetClients() { return GetElements<IClient, SampleDataModel.AccChart>(); }

        public void AddProduct(DbInitializer p) { AddElement((ModelConfiguration)p); }
        public void UpdateProduct(DbInitializer p) { UpdateElement((ModelConfiguration)p); }
        public void RemoveProduct(int id) { RemoveElement<ModelConfiguration>(id); }
        public Task<List<DbInitializer>> GetProducts() { return GetElements<DbInitializer, ModelConfiguration>(); }
